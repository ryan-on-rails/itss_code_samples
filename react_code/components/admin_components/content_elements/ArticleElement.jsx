  ...
  render() {
    ...
    return (
      <div className="form-group clearfix col-md-12">
        <h3 className="content_element-label">Article Element</h3>
        ...
        <div>
          ...
          <div className="form-group col-md-2">
            <label>
              <input type="checkbox"
                defaultChecked={element.show_title || false}
                name="show_title"
...
export default connect(select)(ArticleElement);
