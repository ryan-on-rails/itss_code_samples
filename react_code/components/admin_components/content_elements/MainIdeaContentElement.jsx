...
class MainIdeaContentElement extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="form-group clearfix col-md-12">
        <h3 className="content_element-label">Main Idea Element</h3>
...
export default connect(select)(MainIdeaContentElement);
